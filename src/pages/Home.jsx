      ...
      <div className="flex-1 min-h-0 flex flex-col px-1 sm:px-4 py-1 sm:py-2 max-w-md mx-auto w-full overflow-hidden">
        ...
        <div className="flex items-center justify-center gap-4 sm:gap-6 mt-3 sm:mt-6 px-2 shrink-0 pb-1">
          <button
            ...
            aria-label="넘기기"
          >
            <span className="w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-white border-2 border-primary/30 flex items-center justify-center text-red-500 text-lg sm:text-xl font-bold shadow-card group-hover:border-red-400 group-hover:bg-red-50 transition-colors">
              ✕
            </span>
          ...
          <button
            ...
            aria-label="좋아요"
          >
            <span className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white border-2 border-primary/30 flex items-center justify-center text-red-500 text-2xl sm:text-3xl shadow-card group-hover:border-red-400 group-hover:bg-red-50 transition-colors">
              ♥
            </span>
          ...
          <button
            ...
            aria-label="다이렉트 메시지"
          >
            <span className="w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-white border-2 border-primary/30 flex items-center justify-center text-blue-500 shadow-card group-hover:border-blue-400 group-hover:bg-blue-50 transition-colors">
